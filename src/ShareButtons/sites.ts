...
export default {
  wechat: {
    name: '微信好友',
    // icon: import('./img/weixin.png')
  },
  // weixintimeline: {
  //     name: '朋友圈',
  //     //icon: import('./img/weixin_timeline.png')
  // },
  qq: {
    name: 'QQ好友',
    // icon: import('./img/qq.png'),
    scheme: 'mqqapi://share/to_fri?src_type=web&version=1&file_type=news',
  },
  qzone: {
    name: 'QQ空间',
    // icon: import('./img/qzone.png'),
